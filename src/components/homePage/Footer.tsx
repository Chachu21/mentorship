...
const Footer = () => {
  return (
    <footer className="container mx-auto max-w-screen-2xl bg-gray-800 dark:bg-gray-800 pt-4 pb-8 xl:pt-8">
          ...
          {/* <li className="w-1/2 md:w-1/3 lg:w-1/3">
            <div className="text-center">
              ...
              <ul>
                ...
                <li className="mb-4 transition-colors duration-200 hover:text-gray-800 dark:hover:text-white">
                  <Link href="/facebuk">Facebook</Link>
                </li>
                <li className="mb-4 transition-colors duration-200 hover:text-gray-800 dark:hover:text-white">
                  <Link href="/twitter">Twitter</Link>
                </li>
                <li className="mb-4 transition-colors duration-200 hover:text-gray-800 dark:hover:text-white">
                  <Link href="/linkendin">LinkedIn</Link>
                </li>
              </ul>
            </div>
          </li> */}
