...
const AboutUs = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-10 mt-10">
      <div className="bg-white p-12 max-w-4xl shadow-lg rounded-lg">
        <h1 className="text-3xl font-extrabold mb-8 text-gray-900">About Us</h1>
        <p className="text-gray-800 text-xl leading-relaxed mb-6">
          Welcome to our mentorship system!  we are dedicated
          to connecting mentors and mentees to foster growth, learning, and
          professional development. Our platform provides an easy and efficient
          way for individuals to find the right mentor or mentee and build
...
const SuccessStory = () => {
  return (
    <div className="bg-white p-12 max-w-4xl mt-10 shadow-lg rounded-lg">
      <h2 className="text-3xl font-extrabold mb-8 text-gray-900">
        Success Story
      </h2>
      <div className="flex flex-col md:flex-row items-center mb-6 p-7">
        <img
...
const HowToFindWork = () => {
  return (
    <div className="bg-white p-12 max-w-4xl mx-auto mt-10  rounded-lg">
      ...
      <div className="flex flex-col md:flex-row items-stretch">
        ...
        <div className="w-full md:w-1/2 p-8 text-gray-800 text-lg leading-relaxed flex flex-col justify-center">
          ...
          <p className="mt-6 text-center md:text-left">
            By following these steps, you'll be well on your way to making a
            significant impact in your career or helping others advance their
